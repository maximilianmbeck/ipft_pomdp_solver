...
struct Config {
    ...
    Config(int search_depth_,
           ...
           bool print_search_step_results)
            : search_depth(search_depth_), time_per_move(time_per_move_),  // default 1000
              ...
              sim_len(sim_len_), eval_len(eval_len_), pw_k_obs(pw_k_obs_), // default 5.0
              ...
              record_statistics(record_statistics), convergence_eval(convergence_eval),
