...
public:
     ...
     */
    virtual std::unique_ptr<World> initializePOMDPWorld(std::shared_ptr<POMDP> model) = 0;
     ...
     * @return Solver*
     */
    virtual std::unique_ptr<Solver> initializeSolver(std::shared_ptr<POMDP> model,
