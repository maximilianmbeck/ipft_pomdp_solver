...
public:
    ...
    std::vector<State*> weighted_posterior_particles_; // weighted particle set before resampling
...
public:
    ...
    virtual void setReinvigorationStrategy(std::unique_ptr<ParticleReinvigorator>&& reinvigorator);
