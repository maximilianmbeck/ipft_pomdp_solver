...
constexpr double DOUBLEWEIGHTEQLIM =
    1e-300; // default 1e-160, MINIMUM DOUBLE VAL: 2.22507e-308
...
inline double discount(int d) { return std::pow(config.discount_gamma, d); }
