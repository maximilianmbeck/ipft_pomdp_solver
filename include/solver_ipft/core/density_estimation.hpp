...
public:
    ...
    virtual double multivariateValue(const State* s,
...
public:
    ...
    double multivariateValue(const State* s,
                             const ParticleBelief* belief,
...
public:
    KernelDensityEstimator()
            : bwSelector_(std::make_unique<RotBandwidthSelector>()), kernel_(std::make_unique<NormalKernel>()) {
    }
