...
public:
    ...
    virtual double computeDensityValue(const State* s, const ParticleBelief* b) const = 0;
};
...
public:
    ...
    virtual std::vector<double> computeBandwidthMatrixDiagElmts(const ParticleBelief* b) const = 0;
};
...
public:
    virtual double univariateValue(const State* s, const ParticleBelief* belief, const double& bandwidth) const = 0;
    virtual double multivariateValue(const State* s, const ParticleBelief* belief, const std::vector<double>& bandwidth) const = 0;
};
...
public:
    ...
    std::vector<double> computeBandwidthMatrixDiagElmts(const ParticleBelief* b) const override;
};

// Normal (Gaussian) kernel (default kernel)
class NormalKernel : public KernelFunction {
public:
    double univariateValue(const State* s, const ParticleBelief* belief, const double& bandwidth) const override;
    double multivariateValue(const State* s, const ParticleBelief* belief, const std::vector<double>& bandwidth) const override;
};
