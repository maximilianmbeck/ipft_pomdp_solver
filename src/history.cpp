...
Action History::action(int t) const { return actions_[t].action_; }

ValuedAction History::valuedAction(int t) const { return actions_[t]; }
...
Action History::lastAction() const { return actions_.back().action_; }

ValuedAction History::lastValuedAction() const { return actions_.back(); }
