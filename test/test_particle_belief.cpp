...
//   EXPECT_TRUE(wstd < Globals::DOUBLEEQLIM) << "The calculated std is: " <<
//   wstd;
// }
...
//   EXPECT_LE(std::abs(posteriorMean->get(0) - obsPos),
//             std::abs(priorMean->get(0) - obsPos));
...
//   // scenario: solver belief initially uniformly distributed, world starts
//   with
...
//   // static_cast<Action>(cld::CLDAction::NEG3)}; DeterministicActionChooser
//   actCh(actionSeq);
...
// //
// ---------------------------------------------------------------------------
// //    0 | -14.2260 |   -0.3686 |   9.7104 |   3.0000 |     -3.9420 |
// -1.000000
// //    1 | -11.2460 |   -0.0278 |   7.1668 |   3.0000 |      4.2255 |
// -1.000000
// //    2 |  -8.1918 |    4.1763 |   4.7600 |   3.0000 |     -9.4116 |
// -1.000000
// //    3 |  -5.3134 |    1.6291 |   4.7972 |   3.0000 |      5.7384 |
// -1.000000
// //    4 |  -2.2995 |    5.6189 |   3.0171 |   3.0000 |      3.1500 |
// -1.000000
// //    5 |   0.7549 |    6.3821 |   2.3698 |  -3.0000 |      4.8546 |
// -1.000000
// //    6 |  -2.3222 |    3.7990 |   1.8335 |  -3.0000 |     -2.8043 |
// -1.000000
// //    7 |  -5.3013 |    0.9629 |   1.5279 |  -1.0000 |     17.4035 |
// -1.000000
// //    8 |  -6.2878 |    0.4179 |   3.2666 |   0.0000 |    -11.7572 |
// -100.000000
