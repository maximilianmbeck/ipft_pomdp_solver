...
//         std::vector<State *> states = debug::doubleVec2StateVec(numbers,
//         this->model_); belErr1StepNext = new ParticleBelief(states, false,
...
//     EXPECT_DOUBLE_EQ(-2.162244658288974, belief1entropy);  // value from
//     julia function information()
// }
...
//     LOG(INFO) << "Silvermans Bandwidth all particles equal: " <<
//     rotBandwidth; double kdeAllPEqual =
//     kde.computeDensityValue(belief2->particle(0), belief2); LOG(INFO) << "KDE
//     at a state pos in particle set all particles equal: " << kdeAllPEqual;
// }
...
//     EXPECT_DOUBLE_EQ(17.102888161353903, belief2entropy);  // value from
//     julia function information()
// }
...
//     double infrew = ifm.computeDiscInfGain(1.0, belErr1StepNext,
//     belErr1Step); LOG(INFO) << "entr val belErr1Step: " << entrBelErr1Step;
//     LOG(INFO) << "entr val all particles equal: " << entrBelErr1StepNext;
//     LOG(INFO) << "inf reward: " << infrew *
//     Globals::config.inf_gather_constant_lambda;
// }
